###############################################################################
################## eduAv Final Prototype Class Functionality ##################
###############################################################################
...
class eduAv():
    ...
    def __init__(self):
        ...
        self.skin_tone_choices = ["SKIN1", "SKIN2", "SKIN3", "SKIN4"] # ["#FFCCAA", "#D38D5F", "#AA4400", "#2B1100"]
    ...
    def get_eduAv(self):
        return self.user_name, self.skin_tone, self.eyes, self.nose, self.mouth, self.hair



def main():
    print ("\nWelome to the 'eduAv' creator, your first step in creating your very own personalised educational avatar!")
    ...
    while True:
        ...
        bool_test = user_eduAv.set_skin_tone(skin_tone.upper())
        if bool_test:
            break
    ...
    while True:
        ...
        bool_test = user_eduAv.set_eyes(eyes.upper())
        if bool_test:
            break
    ...
    while True:
        ...
        bool_test = user_eduAv.set_nose(nose.upper())
        if bool_test:
            break
    ...
    while True:
        ...
        bool_test = user_eduAv.set_mouth(mouth.upper())
        if bool_test:
            break
    ...
    while True:
        ...
        bool_test = user_eduAv.set_hair(hair.upper())
        if bool_test:
            break
    ...
    while True:
        ...
        bool_test = user_eduAv.set_hair_style(hair_style.upper())
        if bool_test:
            break
